...
INSERT INTO `t_admin_user` VALUES ('1538095470413', 'admin2', 'admin', 'admin', 'admin2', '123456', '123456', '123456', '2018-09-28', '2018-09-28', '0:0:0:0:0:0:0:1');
INSERT INTO `t_admin_user` VALUES ('1538095676345', 'admin3', 'admin', 'admin3', 'admin3', '123456', '42315', '1231564', '2018-09-28', '2018-09-28', '0:0:0:0:0:0:0:1');
INSERT INTO `t_admin_user` VALUES ('1538095728084', 'admin4', '123456', '123456', '1232456', '1234564', '123', '1321', '2018-09-28', '2018-09-28', '0:0:0:0:0:0:0:1');
INSERT INTO `t_admin_user` VALUES ('1538095781895', 'admin6', '123456', '123456', '123456', '123456', '123', '456', '2018-09-28', '2018-09-28', '0:0:0:0:0:0:0:1');
INSERT INTO `t_admin_user` VALUES ('1538096762362', 'badfdf', 'sdfdsf', 'sdfsdf', 'sdfsdf', 'sdfsdf', 'sdfsd', 'fsdfsdf', '2018-09-28', '2018-09-28', '0:0:0:0:0:0:0:1');
...
-- ----------------------------
INSERT INTO `t_celebritys` VALUES ('1537760814542', '测试用户2', '测试用户2', '测试用户2', '中国', '汉', '白羊座', 'A', '123', '北京', '北京', '北京', '123', '123', '证书', '作家', 'ORACLE(甲骨文)©', '代表作品', '《成就》', '2018-09-24', '2018-09-24', null, '<p><img src=\"http://localhost:8080//upload/20180924/88711537760808249.jpg\"/>				</p><p>这里我可以写一些输入提示</p><p>\r\n				</p>', null, null, '0');
INSERT INTO `t_celebritys` VALUES ('1537866724496', '测试用户3', '测试用户3', '测试用户3', '中国', '汉', '白羊座', 'A', '123', '北京', '北京', '北京', '123', '123', '证书', '作家', 'ORACLE(甲骨文)©', '代表作品', '《成就》', '2018-09-25', '2018-09-25', null, '<p><img src=\"http://localhost:8080//upload/20180925/361537866722065.gif\"/>				</p><p>这里我可以写一些输入提示</p><p>\r\n				</p>', null, null, '0');
INSERT INTO `t_celebritys` VALUES ('1537866832966', '测试用户4', '测试用户4', '测试用户4', '中国', '汉', '白羊座', 'A', '123', '北京', '北京', '北京', '123', '123', '证书', '作家', 'ORACLE(甲骨文)©', '代表作品', '《成就》', '2018-09-25', '2018-09-25', null, '<p><img src=\"http://localhost:8080//upload/20180925/18241537866830501.jpg\"/>				</p><p>这里我可以写一些输入提示</p><p>\r\n				</p>', null, null, '0');
INSERT INTO `t_celebritys` VALUES ('1537867035909', '测试用户4', '测试用户4', '测试用户4', '中国', '汉', '白羊座', 'A', '123', '北京', '北京', '北京', '123', '123', '证书', '作家', 'ORACLE(甲骨文)©', '代表作品', '《成就》', '2018-09-25', '2018-09-25', null, '<p><img src=\"http://localhost:8080//upload/20180925/18241537866830501.jpg\"/>				</p><p>这里我可以写一些输入提示</p><p>\r\n				</p>', null, null, '0');
INSERT INTO `t_celebritys` VALUES ('1537867660274', '测试用户5', '测试用户5', '测试用户5', '中国', '汉', '白羊座', 'A', '100', '北京', '北京', '北京', '100100100010101100', '110-110-110', '证书', '作家', 'ORACLE(甲骨文)©', '代表作品', '《成就》', '2018-09-25', '2018-09-25', null, '<p>				</p><p>这里我可以写一些输入提示</p><p>\r\n				<img src=\"http://img.baidu.com/hi/jx2/j_0002.gif\"/></p>', null, null, '0');
INSERT INTO `t_celebritys` VALUES ('1537868893096', '测试用户6', '测试用户6', '测试用户6', '中国', '汉', '白羊座', 'A', '123', '北京', '北京', '北京', '123', '123', '证书', '作家', 'ORACLE(甲骨文)©', '代表作品', '《成就》', '2018-09-25', '2018-09-25', null, '<p>				</p><p>这里我可以写一些输入提示</p><p>\r\n				</p>', null, null, '0');
INSERT INTO `t_celebritys` VALUES ('1537874270900', '测试用户8', '测试用户8', '测试用户8', '中国', '汉', '白羊座', 'A', '123', '北京', '北京', '北京', '123', '123', '证书', '作家', 'ORACLE(甲骨文)©', '代表作品', '《成就》', '2018-09-25', '2018-09-25', null, '<p>				</p><p>这里我可以写一些输入提示</p><p>\r\n				</p>', null, null, '0');
INSERT INTO `t_celebritys` VALUES ('1537874379375', '测试用户9', '测试用户8', '测试用户8', '中国', '汉', '白羊座', 'A', '123', '北京', '北京', '北京', '123', '123', '证书', '作家', 'ORACLE(甲骨文)©', '代表作品', '《成就》', '2018-09-25', '2018-09-25', null, '<p>				</p><p>这里我可以写一些输入提示</p><p>\r\n				</p>', null, null, '0');
INSERT INTO `t_celebritys` VALUES ('1538276389693', '测试用户09301059', '测试用户09301059', '测试用户09301059', '中国', '汉', '白羊座', 'A', '180', '北京', '北京', '北京', '110110110011221100', '101-100100-01', '证书', '作家', 'ORACLE(甲骨文)©', '代表作品', '《成就》', '2018-09-30', '2018-09-30', null, '<p><img src=\"http://localhost:8080//upload/20180930/27611538276386170.png\"/>这里我可以写一些输入提示</p>', null, null, '0');
INSERT INTO `t_celebritys` VALUES ('1000000000000001', '测试用户1', '测试用户1', '测试用户1', '中国', '汉', '白羊座', 'A', '123', '北京', '北京', '北京', '123', '123', '证书', '作家', 'ORACLE(甲骨文)©', '代表作品', '《成就》', '2018-09-24', '2018-09-24', null, '<p><img src=\"http://localhost:8080//upload/20180924/65951537758747368.gif\"/>				</p><p>这里我可以写一些输入提示</p><p>\r\n				</p>', null, null, '0');
...
-- ----------------------------
INSERT INTO `t_news_type` VALUES ('10001', 'CS10001', '测试类别');
INSERT INTO `t_news_type` VALUES ('1538314489325', 'LB_SH', '社会');
INSERT INTO `t_news_type` VALUES ('1538314518287', 'LB_WH', '文化');
INSERT INTO `t_news_type` VALUES ('1538314532494', 'LB_CJ', '财经');
INSERT INTO `t_news_type` VALUES ('1538314578299', 'LB_SHUHUA', '书画');
INSERT INTO `t_news_type` VALUES ('1538314596831', 'LB_YIYAO', '医药');
INSERT INTO `t_news_type` VALUES ('1538314619759', 'LB_MINGQI', '名企');
